...
def compare_to_trials(cal):
    ...
    if r > 1.25:
        ...
        print(f"\n    >>> MIMIC says patients decline ~{1/r:.1f}x SLOWER than the trials. Check")
        print("        the cohort filter: --chronic-only selects on the outcome, and a cohort")
        print("        dominated by stable patients will understate progression.")
    else:
