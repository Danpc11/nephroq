# NephroQ — Validation Report (example output)

> This is a sample of the report automatically generated by
> `mvp_calibration.py`. Run the script yourself to produce a live version
> (synthetic by default, or with your own data via `CKD_CSV=...`).
